...
export default function Fairteiler() {
  ...
  return (
    <Screen tabBar={false}>
      ...
      <Button label="Meine Regalmeldungen & Betreuung" variant="soft" color={col} onPress={()=>router.push('/regalnachweise')}/><Text style={[T.label, { marginTop: 18, marginBottom: 8 }]}>Was machst du gerade?</Text>
      <Row style={{ gap: 10 }}>
