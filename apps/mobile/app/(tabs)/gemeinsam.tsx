      ...
      <Text style={[T.h1]}>{t('together.title')}</Text>
          <Appear delay={40}>
            <Card style={{ marginTop: S.lg, backgroundColor: col }}>
              ...
              <Text style={[T.h2, { color: '#fff', marginTop: 2 }]}>{t('tabs.together.co2Progress', { amount: (FRANKFURT_GOAL.weekSoFarKg / 1000).toLocaleString(locale, { minimumFractionDigits: 1, maximumFractionDigits: 1 }), target: (FRANKFURT_GOAL.weekTargetKg / 1000).toLocaleString(locale) })}</Text>
